    ...
    <div className="content-container">
      <Features>
        <Feature large centered>
            <h3>Releases <br className="show-on-mobile"/>(preview)</h3>
            ...
            <div className='mt-4 gap-4 flex justify-center'>
                <Cards.Card icon={<FontAwesomeIcon icon={faDownload} size="xl" />} title="Download now" href="https://github.com/FOSSBilling/FOSSBilling/releases"/>
            </div>
        </Feature>
