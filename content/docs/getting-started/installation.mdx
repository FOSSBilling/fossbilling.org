...
# <FAIcon icon="faServer" /> Installing FOSSBilling
...
<Callout type="info">
	...
	You may need to apply [fixed permissions](https://fossbilling.org/docs/troubleshooting#permission-issues) to the FOSSBilling folders before the installer works.
</Callout>
