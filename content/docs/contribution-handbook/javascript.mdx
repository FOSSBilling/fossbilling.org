...
# <FAIcon icon="faRobot" /> API wrapper in JavaScript
<Callout type="info" emoji={<FAIcon icon="faCircleInfo" />}>
...
To disable the spinner, do one of the following things:
 ...
 - Pass `false` to the spinner option when using the API wrapper. (this parameter is completely optional unless you wan to disable the spinner)
