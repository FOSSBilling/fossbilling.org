...
<div className="home-content">
  <div className="content-container">
    ...
    <p className="subtitle">Before downloading, please keep in mind: <br />- FOSSBilling is currently considered pre-production software <br />- You should have a strong technical knowledge, especially about webhosting if you wish to both sell webhosting or use FOSSBilling <br />- Due to the pre-production nature of FOSSBilling, you should <strong>always</strong> read the release notes before updating <br />- We recommend having understanding PHP and software development so you may aid in FOSSBilling development as well as resolve issues for yourself if needed<br /></p>
  </div>
