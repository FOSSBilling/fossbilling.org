    ...
    <div className="content-container">
      <Features>
        ...
        <Feature centered>
            ...
            <p>If you are a developer, you might want to use this build instead. Preview builds are automatically generated from the main branch after each commit. You must have a GitHub account to access and download the preview artifacts.</p>
            <div className='mt-4 gap-4 flex justify-center'>
