    ...
    <div className="content-container">
      <Features>
        <Feature large centered>
            ...
            <ul>
              <li>A suitable web server (Apache/nginx/LSWS/Lighttpd)</li>
              <li>PHP 8.0 or higher required. Only PHP versions that still receive security patches are supported.</li>
              <li>MySQL 8+ or MariaDB 10.3+ required. Other direct MySQL compatible DBs may work but are not supported.</li>
              <li>The following PHP extensions:</li>
                <ul>
                  <li>curl</li>
                  <li>intl</li>
                  <li>mbstring (optional, but recommended)</li>
                  <li>openssl</li>
                  <li>pdo_mysql</li>
                  <li>xml</li>
                  <li>zlib</li>
