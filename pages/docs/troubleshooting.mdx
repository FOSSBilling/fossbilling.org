...
If you are trying to run an installation of FOSSBilling in a subfolder rather than a subdomain, i.e. 'https://myfancyhost.com/fossbilling' instead of 'https://fossbilling.myfancyhost.com' then it will not work. 
