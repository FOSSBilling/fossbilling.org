...
Because of this, some may find that their FOSSBilling instance isn't displaying the language they set in the configuration file. This is not a bug and it is just FOSSBilling using the preferred whatever your browser says your preferred language is.
