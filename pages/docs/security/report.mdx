...
A detailed guide can be found here: [CONTRIBUTING](https://github.com/FOSSBilling/FOSSBilling/blob/main/CONTRIBUTING.md). However if you're still unsure or it's too much to read drop a message on [Discord](https://fossbilling.org/discord).
