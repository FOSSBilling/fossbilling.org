...
Log in to phpMyAdmin using the credentials you use to log in to your web hosting control panel. This will vary depending on your server. If you are using shared hosting and unsure, please contact your web hosting provider.
