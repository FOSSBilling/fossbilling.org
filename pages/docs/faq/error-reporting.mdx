...
The FOSSBilling instance ID is a unique id that is specific to your FOSSBilling installation, they match the RFC4122 version 5 specification and are created off of your installation's URL.
