...
No, there is currently no integration with Pterodactyl. 

This is not because we hate Ptero, or don't want them to be integrated, or because it is overly difficult or impossible. It is simply because none of the core contributors to FOSSBilling are using Pterodactyl, and it is not one of the higher or more urgent things on our priority list. 

There are frequent discussions about this on [Discord](https://fossbilling.org/discord) and at least one community member has expressed an interest in developing a Ptero module, but there is no guarantee or timeline. As noted above, this is open source software that is designed to be extendable, feel free to jump in and constribute. 
