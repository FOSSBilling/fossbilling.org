...
### Enhancements
 ...
 - The Extension Directory has been moved to a seperate tab for both Payment Gateways and Domain Registrars.
...
### Bug Fixes
 ...
 - Fixed an issue with the the Massmailer module's send functionality.
