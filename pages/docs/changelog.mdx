...
## Version 0.2.4 (Release date TBD)

### Security
 - Added a new security mode which will default to 'strict'
   - The strict mode will force the use of HTTPS and use more secure cookie settings.
