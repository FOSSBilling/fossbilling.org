...
We are nearing the 0.6.0 release in the near future. All major new features are implemented and at this stage it is mostly bug fixing and regression testing remaining before this release can be made official.

If you want a nice overview of the most exciting changes and some screenshots, give a look at the [FOSSBilling forum](https://forum.fossbilling.org/d/100-060-sneak-peek).
...
- Some constants have been renamed or removed.
- The behavior of invoice numbering has changed and it is not continuous.
...
- The requirements system has been reworked and will now list missing recommended extensions. Additionally, we've rechecked the system requirements and have properly documented them on [the documentation](https://fossbilling.org/docs/getting-started/requirements).
