...
<Callout type="error" emoji={<FontAwesomeIcon icon={faHand} />}>
  ...
  Thing should still work without any issues going to a version of FOSSBilling that's newer than 0.5.6, however you should expect issues if updating from a version of BoxBilling older than 4.22.1.5.
