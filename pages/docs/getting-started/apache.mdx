...
- Domain Example: `http://www.serveraddress.com/install`
- IP Example: `http://0.0.0.0/install`

Once this step is completed then the server is ready to go! If you want to do SSL continue on!

If you recieve an Apache test page after this step make sure to remove `index.html` from `/var/www/html`
