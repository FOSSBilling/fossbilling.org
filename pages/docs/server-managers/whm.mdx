...
Due to technical limitations between FOSSBilling and WHM, FOSSBilling cannot create hosting packages automatically.
Because of this, you should first create the hosting plans (packages) you want to use from within WHM and define the limitations and capabilities you want it to have there, as FOSSBilling will be unable to change or define them.
