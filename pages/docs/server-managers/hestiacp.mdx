...
[Here](https://development.hestiacp.com/docs/server-administration/rest-api.html#i-m-unable-to-connect-to-the-api) is their documentation for the whitelisting the IP address. 
[here](https://development.hestiacp.com/docs/user-guide/account.html#api-access-keys) is where they talk about creating the access key.
...
5. Ender the access key ID and secret key you created within HestiaCP.
