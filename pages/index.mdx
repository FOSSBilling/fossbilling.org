...
<div className="home-content">
  <div className="content-container">
    ...
    <p className="subtitle"><Link href="/docs">Get started →</Link><br className="show-on-mobile"/><span className="text-sm">...or jump straight to [installing FOSSBilling](/docs/getting-started)</span></p>
  </div>
