...
We wanted to move forward and create a usable and dependable open source billing solution that will be well maintained and not commercialised. The result of those desires is FOSSBilling. At this moment both solutions are quite similar with FOSSBilling containing minor updates, bug fixes, and security improvements, but in the future they will move further and futher apart as development of FOSSBilling continues.
