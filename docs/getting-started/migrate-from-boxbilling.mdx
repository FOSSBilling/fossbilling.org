...
We have slightly changed our theming system. If you use a custom theme for the client area, you will need to make some changes on it to get it working with FOSSBilling. A guide for that is on the way.
